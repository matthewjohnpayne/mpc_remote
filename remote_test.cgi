...
# Set up a default result-dictionary that will be used when no meaningful input is supplied
result_dict = {'No Usable Input': True , 'file': __file__ }
...
# If some kind of error occurred, report back in a dictionary ...
